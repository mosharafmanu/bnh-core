...
<?php if ( $bnh_term instanceof WP_Term && 'health_topic' === $bnh_term->taxonomy && 0 !== (int) $bnh_term->parent ) : ?>
	<?php get_template_part( 'template-parts/archives/child-topic-archive', null, array( 'context' => $bnh_context ) ); ?>
<?php else : ?>
