				...
				if ( function_exists( 'bnh_core_render_responsive_picture' ) ) {
					bnh_core_render_responsive_picture(
						...
						array(
							...
							'size_group' => 'topic-featured',
						)
					);
				} else {
					echo get_the_post_thumbnail( $bnh_post, 'bhn-688', array( 'class' => 'topic-card__image' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				}
				?>
			</div>
		<?php endif; ?>
